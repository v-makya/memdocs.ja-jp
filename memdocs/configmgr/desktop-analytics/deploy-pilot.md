...
Configuration Manager で、Desktop Analytics からのデータを使用して、パイロットと運用環境への展開のためのコレクションが作成されます。 各展開段階の後にデバイスが正常であることを確認するには、次の手順に従って、Desktop Analytics に統合された段階的な展開を作成します。
