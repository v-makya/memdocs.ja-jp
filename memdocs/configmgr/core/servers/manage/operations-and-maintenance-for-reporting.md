...
> [!NOTE]
> **電子メール**サブスクリプションオプションを有効にするには Reporting Services で電子メールの設定を構成する必要があります。 詳細については、「[Reporting Services の電子メール配信](/sql/reporting-services/subscriptions/e-mail-delivery-in-reporting-services)」を参照してください。
