...
**資産インテリジェンス** カテゴリに表示される 67 件のレポートを次に示します。  
...
|**ハードウェア 04A - 複数ユーザー向けコンピューター (共有)**|サインイン時間が 66% を超えるユーザーがいないためにプライマリ ユーザーがいないと見なされるコンピューターを表示します。|  
...
|**ハードウェア 09A - コンピューターの検索**|キーワード フィルターに一致するコンピューターの概要を表示します。 これらのフィルターは、コンピューター名、Configuration Manager サイト、ドメイン、上位のコンソール ユーザー、オペレーティング システム、製造元、またはモデルです。|  
...
|**ライセンス 02A - 有効期限が近づいている時間範囲別のライセンス数**|有効期限が近づいているライセンスの数を指定した時間範囲別に表示します。 表示される製品には、ソフトウェア ライセンス サービスによって管理されるライセンスがあります。|  
...
|**ライセンス 04B - ソフトウェア ライセンス サービスによって管理される特定の製品が存在するコンピューター**|ソフトウェア ライセンス サービスによって管理される、指定された製品が含まれるコンピューターを表示します。|  
...
|**ライセンス 14A - Microsoft ボリューム ライセンス調整レポート**|Microsoft ボリューム ライセンス契約を通じて取得されたソフトウェア ライセンスの調整に関する情報と、実際のインベントリ数を表示します。|  
...
|**ライフサイクル 05A - 製品ライフサイクル ダッシュボード**|バージョン 1810 以降では、このレポートに、コンソール内のダッシュボードと同様の情報が含まれます。|
...
|レポート名|[説明]|  
|-----------------|-----------------|  
|**デバイスのファームウェア状態の詳細**|UEFI、SecureBoot、TPM の状態の詳細が表示されます。 **注**:このレポートは、バージョン 1810 には含まれません。<!--SCCMDocs issue #1189-->|  
...
**タスク シーケンス - 展開ステータス** カテゴリに表示される 11 件のレポートを次に示します。
...
|**コンピューターのタスク シーケンス展開の履歴**|指定した対象コンピューターにある指定したタスク シーケンス展開の各ステップのステータスが表示されます。 レコードが返されない場合、コンピューターでタスク シーケンスは開始されていません。|  
...
**タスク シーケンス - 展開**カテゴリに表示される 11 件のレポートを次に示します。
...
|**不明なコンピューターで利用可能なすべてのタスク シーケンス展開**|不明なコンピューターを含むコレクションに展開されている、サイトから開始されたすべてのタスク シーケンス展開の詳細が表示されます。|  
...
**タスク シーケンス - 進行状況**カテゴリに表示される 5 件のレポートを次に示します。
...
**タスク シーケンス - 参照**カテゴリに表示される 1 件のレポートを次に示します。
...
**ユーザー - デバイスのアフィニティ** カテゴリに表示される 2 件のレポートを次に示します。
...
**ユーザー データとプロファイルのヘルス** カテゴリに表示される 4 件のレポートを次に示します。

|レポート名|[説明]|  
|-----------------|-----------------|  
|**フォルダー リダイレクトのヘルス レポート - 詳細**|特定のユーザーのリダイレクト フォルダーごとに、フォルダー リダイレクトのヘルス状態の詳細が表示されます。|  
|**ローミング ユーザー プロファイルのヘルス レポート - 詳細**|指定したユーザーのローミング ユーザー プロファイルのヘルス状態の詳細が表示されます。|  
|**ユーザー データとプロファイルのヘルス レポート - 詳細**|フォルダー リダイレクトまたはローミング ユーザー プロファイルのエラーまたは警告の詳細が表示されます。 このレポートは概要レポートを詳しくしたものです。|  
...
**ユーザー** カテゴリに表示される 3 件のレポートを次に示します。
...
**仮想アプリケーション** カテゴリに表示される 7 件のレポートを次に示します。

|レポート名|[説明]|  
|-----------------|-----------------|  
|**App-V 仮想環境の結果**|指定したコレクションの、指定した状態になっている指定の仮想環境に関する情報が表示されます。|  
|**資産に関する App-V 仮想環境の結果**|指定した資産の指定した仮想環境に関する情報が表示されます。 指定した仮想環境の展開の種類も表示されます。|  
...
## <a name="vulnerability-assessment"></a>脆弱性の評価

**脆弱性の評価**カテゴリに表示される 1 件のレポートを次に示します。

|レポート名|[説明]|  
|-----------------|-----------------|  
|**脆弱性評価の全体レポート**|特定のコンピューターのセキュリティ、管理、およびコンプライアンスに関する脆弱性を識別します|  



## <a name="wake-on-lan"></a>Wake On LAN  

**Wake On LAN** カテゴリに表示される 7 件のレポートを次に示します。

|レポート名|[説明]|  
|-----------------|-----------------|  
|**Wake On LAN アクティビティの対象となるすべてのコンピューター**|Wake on LAN アクティビティの対象となるコンピューターの一覧を表示する展開の種類を指定します。|  
