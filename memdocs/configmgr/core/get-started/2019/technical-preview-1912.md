...
description: Configuration Manager Technical Preview Branch バージョン 1912 で利用できる新しい機能について説明します。
ms.date: 12/12/2019
...
ms.locfileid: "81697410"
---
# <a name="features-in-configuration-manager-technical-preview-version-1912"></a>Configuration Manager Technical Preview バージョン 1912 の機能

*適用対象:Configuration Manager (Technical Preview Branch)*

この記事では、Configuration Manager の Technical Preview バージョン 1912 で利用できる機能について説明します。 このバージョンをインストールすると、Technical Preview サイトが更新され、新機能が追加されます。
