...
#### <a name="legal-limitations"></a><a name="BKMK_LegalLimitations"></a> 法律上の制限事項  
...
## <a name="asset-intelligence-validation-states"></a><a name="BKMK_ValidationStates"></a> 資産インテリジェンスの検証の状態  
...
|**[更新可能]**|ユーザー定義のカタログ項目は、カタログ同期時に Microsoft によって異なったカテゴリ化が行われています。|**[競合の解決]** 操作を使用し、新しいカテゴリ化情報または以前のユーザー定義値を使用するかどうかを決定します。 競合の解決方法について詳しくは、[資産インテリジェンスの操作](operations-for-asset-intelligence.md)に関するページを参照してください。|カテゴリ化の競合を解決したら、その後のカテゴリ化の更新で、項目に関する新しい情報が導入されない限り、項目は競合として再び検証されることはありません。|  
|**カテゴリ化されていない**|カタログ項目が Microsoft の調査担当者によって定義されておらず、カテゴリ化のために項目が Microsoft に送信されておらず、管理者がユーザー定義のカテゴリ化の値を割り当てていません。|カテゴリ化を要求するか、ローカルのカタログ情報をカスタマイズします。 詳細については、[資産インテリジェンスの操作](operations-for-asset-intelligence.md)に関するページを参照してください。|なし|  
