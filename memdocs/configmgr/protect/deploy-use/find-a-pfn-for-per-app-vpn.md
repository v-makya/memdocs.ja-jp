...
作業しているアプリが既に Windows 10 コンピューターにインストールされている場合は、[Get-AppxPackage](/powershell/module/appx/get-appxpackage) PowerShell コマンドレットを使用して PFN を取得できます。
