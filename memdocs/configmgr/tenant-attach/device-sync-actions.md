...
- 中央管理サイトに [リモートプロバイダー](../core/plan-design/hierarchy/plan-for-the-sms-provider.md)がある場合は、cmpivot の記事の「 [ca のリモートプロバイダー](../core/servers/manage/cmpivot-changes.md#cas-has-a-remote-provider) のシナリオ」に記載されている手順に従います。 <!--7796824-->
