...
2. 返されるデータは Postman の応答本文に表示されます。
    ...
    ![Postman クライアントの状態が 200 OK](./media/reports-proc-data-rest/reports-postman_200OK.png)
...
7. ソリューション エクスプローラーから `Program.cs` を開きます。
    ...
    ![Visual Studio での Program.cs とソリューション エクスプローラー](./media/reports-proc-data-rest/reports-get_rest_data_in.png)
...
10. **Ctrl + F5** を押し、デバッグ モードで Intune.DataWarehouseAPIClient クライアントをビルドし、実行します。
    ...
    ![JSON 形式で取得された日付エンティティ。](./media/reports-proc-data-rest/reports-get_rest_data_output.png)
