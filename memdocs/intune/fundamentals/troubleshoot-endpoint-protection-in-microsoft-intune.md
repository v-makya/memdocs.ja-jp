...
イベント ログとエラー コードを調べて [Microsoft Defender AV での問題をトラブルシューティング](/windows/security/threat-protection/windows-defender-antivirus/troubleshoot-windows-defender-antivirus)します。
