...
- [iOS と iPadOS](/intune-user-help/enroll-ios-device-disa-purebred)
- [Android Enterprise のフル マネージド デバイス](../user-help/enroll-android-device-disa-purebred.md)
...
- [iOS と iPadOS](/intune-user-help/enroll-ios-device-entrust-datacard)
...
- [iOS と iPadOS](/intune-user-help/enroll-ios-device-intercede)
...
## <a name="derived-credentials-for-windows"></a>Windows の派生資格情報
