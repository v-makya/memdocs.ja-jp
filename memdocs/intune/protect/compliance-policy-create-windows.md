...
- **[Configuration Manager からのデバイス コンプライアンスが必要]** :  
  ...
  > [!NOTE]
  > 共同管理のコンプライアンス ワークロードが *Configuration Manager* に設定されている場合にのみ、 **[Configuration Manager からのデバイス コンプライアンスが必要]** を使用します。 この設定を、コンプライアンス ワークロードが *Intune* に設定されている状態で使用すると、全体的なコンプライアンス評価に影響する可能性があります。
