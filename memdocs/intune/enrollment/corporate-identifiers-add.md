...
- 職場または学校の資格情報を使用して Azure Active Directory に参加します。 [Azure Active Directory に登録されているデバイス](/azure/active-directory/devices/overview)は個人用とマークされます。
