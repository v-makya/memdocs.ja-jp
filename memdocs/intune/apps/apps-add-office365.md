...
## <a name="select-the-office-365-suite-app-type"></a>Office 365 Suite アプリの種類を選択する
...
- アプリ スイートを追加のグループに割り当てる方法については、「[アプリをグループに割り当てる](/intune-azure/manage-apps/deploy-apps)」を参照してください。
