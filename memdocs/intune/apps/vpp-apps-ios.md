...
| **App Store へのアクセスをブロックするデバイス構成** | アプリはポータル サイトを使用してインストールおよび更新できます。 | Apple VPP に参加するための招待では、App Store へのアクセスが求められます。 App Store を無効にするポリシーを設定している場合、VPP アプリのライセンスは機能しません。 |
| **アプリの自動更新** | Intune 管理者が、アプリの **[割り当ての種類]** が **[必須]** になっている Apple VPP トークンの設定で構成したようになります。 <br> <br> **[割り当ての種類]** が **[登録済みデバイスで使用可能]** である場合は、利用可能なアプリの更新プログラムをポータル サイトからインストールできます。 | エンド ユーザーが、App Store の個人用設定で構成したようになります。 Intune 管理者がこれを管理することはできません。 |
| **ユーザー登録** | サポートされていません。 | 管理対象 Apple ID を使用してサポートされています。 |
| **ブック** | サポートされていません。 | サポートしています。 |
| **使用中のライセンス** | デバイスごとに 1 ライセンス。 このライセンスはこのデバイスに関連付けられます。 | 同じ個人用 Apple ID を使用している最大 5 台のデバイスに対して 1 ライセンス。 このライセンスはこのユーザーに関連付けられます。 <br> <br> 個人用 Apple ID と Intune の管理対象 Apple ID に関連付けられているエンド ユーザーは、2 つのアプリ ライセンスを使用します。|
