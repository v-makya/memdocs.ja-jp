...
2. **[アプリケーションの種類の選択]** ウィンドウの **[Microsoft 365 アプリ]** セクションで **[Windows 10]** を選択します。
...
4. Intune を使用して追加したアプリをクリックします。 このクイック スタートでは、**Microsoft 365 アプリ** スイートを追加しました。
