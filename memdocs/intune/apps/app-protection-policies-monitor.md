...
>[!NOTE]
> **[最後の同期]** 列は、コンソール内のユーザーの状態レポートと、アプリ保護ポリシーの[エクスポート可能な .csv レポート](/intune/app-protection-policies-monitor#export-app-protection-activities)の両方で、同じ値を表します。 2 つのレポートの値のこの違いは、同期のわずかな遅延です。
>
