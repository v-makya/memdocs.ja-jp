...
- **[IP アドレスまたは FQDN]** :デバイスが接続される VPN サーバーの IP アドレスまたは完全修飾ドメイン名を入力します。 たとえば、「`192.168.1.1`」や「`vpn.contoso.com`」と入力します。
...
- **接続の種類**:以下のベンダーのリストから VPN 接続の種類を選択します。
  ...
  - **NetMotion Mobility**
  - **Pulse Secure**
  - **[カスタム VPN]** : お使いの VPN ベンダーが一覧にない場合は、このオプションを選択します。 以下も構成します:
