...
- iPadOS 13.0 以降
- macOS X 10.12 以降
- Windows 10 以降、および Windows Holographic for Business
...
3. 次のプロパティを入力します。
    ...
    - **[プロファイル]** : **[Wi-Fi]** を選択します。
      ...
      > [!TIP]
      >
      > - 専用デバイス (キオスク) として実行されている **Android Enterprise** デバイスの場合、 **[フル マネージド、専用、会社所有の仕事用プロファイル]** 、 **[Wi-Fi]** の順に選択します。
...
プロファイルは作成されましたが、何も実行できない可能性があります。 次に、[プロファイルを割り当て](device-profile-assign.md)、[その状態を監視](device-profile-monitor.md)します。
